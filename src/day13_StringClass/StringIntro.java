...
public class StringIntro {
    public static void main(String[] args) {
       ...
       String name = "Wooden Spoon";
        ...
        String str1 = new String("Wooden Spoon"); //tgese are different objects in the heap memory
     ...
     System.out.println("er = " + er);
        ...
        System.out.println(s3.equals(s4)); //false because of upper case
        System.out.println(s3==s4); // we dont use this
