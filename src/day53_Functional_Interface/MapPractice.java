...
public class MapPractice {
    public static void main(String[] args) {
        ...
        allUnits.addAll(Arrays.asList(unit1,unit6,unit4,unit2,unit3,unit5));
        ...
        for (Map<String, Double> eachUnit : allUnits) {
            for (Map.Entry<String, Double> entry : eachUnit.entrySet()) {
                ...
                Escape Sequences : 3.0
                Primitives : 6.0
                Operators : 9.0
                If Statements : 9.0
                Switch Statement : 4.0
                Scanner : 6.0
                OOP Abstraction : 14.5
                OOP Polymorphism : 8.5
                Collection : 9.5
                Map : 7.5
                Custom Class : 23.5
                Access Modifiers : 2.5
                String Manipulation : 12.0
                Loops : 17.5
                ...
                Wrapper Classes : 3.0
                ArrayList : 11.5
                OOP Encapsulation : 4.5
                OOP Inheritance : 13.5
                Final keyword : 2.5
                Exceptions : 8.5
                 */
             //  double totalHour= 0;
               // totalHour+= entry.getValue();
        ...
        System.out.println(name1); //Custom Class
        System.out.println(max); //23.5
        System.out.println(name2); //Branching Statements
        System.out.println(min);// 1.5

        System.out.println("Total hour of Java Lessons = " + totalHour);
     //   Total hour of Java Lessons = 240.0
    }
}
/*
