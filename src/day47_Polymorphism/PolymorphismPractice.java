...
import day38_MethodOverriding.carTask.BMW;
import day38_MethodOverriding.carTask.Car;
import day38_MethodOverriding.carTask.Tesla;
import day38_MethodOverriding.carTask.Toyota;

public class PolymorphismPractice {
        public static void main(String[] args) {

            Car[] cars = {
                  /*  new Toyota("Highlander", "2010", 25000, "5", 255000),
                    new BMW("X5", "2014", 32000, 6, 12000),
                    new Toyota("Corolla", "2011", 20000, 1, 310000),
